...
"""
IDEA:
    use a glcm matrix for entropy calulation instead of the shannon entropy
    -> spoiler: shannon works better
"""
...
class EdgeDetect:
    ...
    def gen_seq(self, length):
        ...
        img_name = 'test'
        num_ops = 0
        image = Image.open('02_cm_sp/cm_sp_original.jpg').convert('L')

        entr_image = entropy.combine_entr(image)/255
